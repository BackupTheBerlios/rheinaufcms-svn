...
$php_uploader="/RheinaufCMS/Module/Upload/php/upload2.php"; # CHANGE THIS TO YOUR PHP SCRIPTS URL

$interval=1;				  # how often to refresh the progress bar

$max_upload = 32000000; # set this to whatever you feel suitable for you.
