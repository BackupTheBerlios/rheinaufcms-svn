...
_33.content.innerHTML=" <div class='title' style='background: url("+_33.baseURL+_33.editor.imgURL(_2a?"cell-prop.gif":"row-prop.gif","TableOperations")+") #fff 98% 50% no-repeat'>"+HTMLArea._lc(_2a?"Cell Properties":"Row Properties","TableOperations")+"</div> <table style='width:100%'>   <tr>     <td id='--HA-layout'> "+"    </td>   </tr>   <tr>     <td id='--HA-style'></td>   </tr> </table> ";
