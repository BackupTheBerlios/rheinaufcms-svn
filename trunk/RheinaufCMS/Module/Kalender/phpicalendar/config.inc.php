...
$template 				= 'buddy';		// Template support
$default_view 			= 'month';			// Default view for calendars = 'day', 'week', 'month', 'year'
$minical_view 			= 'current';		// Where do the mini-calendars go when clicked? = 'day', 'week', 'month', 'current'
$default_cal 			= 'buddy';		// Exact filename of calendar without .ics. Or set to $ALL_CALENDARS_COMBINED to open all calenders combined into one.
...
$timezone 				= 'Europe/Berlin';				// Set timezone. Read TIMEZONES file for more information
...
$cookie_uri				= 'http://buddy-ev.de/RheinaufCMS/Module/Kalender/phpicalendar'; 				// The HTTP URL to the PHP iCalendar directory, ie. http://www.example.com/phpicalendar -- AUTO SETTING -- Only set if you are having cookie issues.
$download_uri			= 'http://buddy-ev.de/RheinaufCMS/Module/Kalender/phpicalendar/calendars'; 				// The HTTP URL to your calendars directory, ie. http://www.example.com/phpicalendar/calendars -- AUTO SETTING -- Only set if you are having subscribe issues.
$default_path			= 'http://buddy-ev.de/RheinaufCMS/Module/Kalender/phpicalendar'; 				// The HTTP URL to the PHP iCalendar directory, ie. http://www.example.com/phpicalendar
$charset				= 'iso-8859-1';			// Character set your calendar is in, suggested UTF-8, or iso-8859-1 for most languages.
