{HEADER}
		...
		<tr>
			<td align="center" valign="middle">
				<table width="100%" border="0" cellspacing="0" cellpadding="0">
					<tr valign="top">
						<td align="left" width="615" class="title"><h1>{DISPLAY_DATE}</h1></td>
	...
	<br /><div>
	<div style="float:left">{MONTH_SMALL|+0}</div><div style="float:left">{MONTH_SMALL|+1}</div><div>{MONTH_SMALL|+2}</div>
	</div>
