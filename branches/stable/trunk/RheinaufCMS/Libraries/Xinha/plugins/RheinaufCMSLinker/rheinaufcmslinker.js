RheinaufCMSLinker._pluginInfo={name:"RheinaufCMSLinker",version:"1.0",developer:"James Sleeman",developer_url:"http://www.gogo.co.nz/",c_owner:"Gogo Internet Services",license:"htmlArea",sponsor:"Gogo Internet Services",sponsor_url:"http://www.gogo.co.nz/"};
HTMLArea.loadStyle("dTree/dtree.css","RheinaufCMSLinker");
HTMLArea.Config.prototype.RheinaufCMSLinker={"backend":_editor_url+"plugins/RheinaufCMSLinker/scan.php","backend_data":null,"files":null};
function RheinaufCMSLinker(_1,_2){
this.editor=_1;
this.lConfig=_1.config.RheinaufCMSLinker;
var _3=this;
...
RheinaufCMSLinker.prototype._lc=function(_a){
return HTMLArea._lc(_a,"RheinaufCMSLinker");
};
RheinaufCMSLinker.prototype._createLink=function(a){
...
var _c={type:"url",href:"http://",target:"",p_width:"",p_height:"",p_options:["menubar=no","toolbar=yes","location=no","status=no","scrollbars=yes","resizeable=yes"],to:"alice@example.com",subject:"",body:"",anchor:""};
...
this._dialog=new RheinaufCMSLinker.Dialog(this);
};
RheinaufCMSLinker.Dialog_dTrees=[];
RheinaufCMSLinker.Dialog=function(_22){
var _23=this;
this.Dialog_nxtid=0;
this.linker=_22;
this.id={};
...
HTMLArea._loadback(_editor_url+"plugins/RheinaufCMSLinker/dTree/dtree.js",function(){
_24._prepareDialog();
});
return;
}
...
var _27=this.files;
if(this.html==false){
HTMLArea._getback(_editor_url+"plugins/RheinaufCMSLinker/dialog.html",function(txt){
_24.html=txt;
_24._prepareDialog();
});
return;
...
var _29=this.html;
var _2a=this.dialog=new HTMLArea.Dialog(_25.editor,this.html,"RheinaufCMSLinker");
var _2b=HTMLArea.uniq("dTree_");
this.dTree=new dTree(_2b,_editor_url+"plugins/RheinaufCMSLinker/dTree/");
eval(_2b+" = this.dTree");
...
RheinaufCMSLinker.Dialog.prototype.makeNodes=function(_30,_31){
for(var i=0;i<_30.length;i++){
if(typeof _30[i]=="string"){
this.dTree.add(RheinaufCMSLinker.nxtid++,_31,_30[i].replace(/^.*\//,""),"javascript:document.getElementsByName('"+this.dialog.id.href+"')[0].value=unescape('"+escape(_30[i])+"');document.getElementsByName('"+this.dialog.id.type+"')[0].click();document.getElementsByName('"+this.dialog.id.href+"')[0].focus();void(0);",_30[i]);
}else{
if(_30[i].length){
...
var id=RheinaufCMSLinker.nxtid++;
}
if(_30[i].title){
var _34=_30[i].title;
}else{
...
if(_30[i].url){
var _35="javascript:document.getElementsByName('"+this.dialog.id.href+"')[0].value=unescape('"+escape(_30[i].url)+"');document.getElementsByName('"+this.dialog.id.type+"')[0].click();document.getElementsByName('"+this.dialog.id.href+"')[0].focus();void(0);";
}else{
var _35="";
}
...
RheinaufCMSLinker.Dialog.prototype._lc=RheinaufCMSLinker.prototype._lc;
RheinaufCMSLinker.Dialog.prototype.show=function(_36,ok,_38){
if(!this.ready){
var _39=this;
